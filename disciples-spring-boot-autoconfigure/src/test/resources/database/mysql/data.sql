...
insert into `iam_group`(`id`,`name`,`roles`,`create_time`) values (1,'管理员','ADMIN', '2020-02-15 10:28:14');
insert into `iam_user`(`id`,`username`,`create_time`,`email`,`name`,`password`,`roles`,`enabled`,`phone`) values 
  (1,'admin','2020-02-15 10:28:14',NULL,'Administrator','e10adc3949ba59abbe56e057f20f883e',NULL,1,NULL);
